                    ...
                    <div className=' flex-col gap-2 flex '>
                            <p className='font-semibold font-poppins text-xl tracking-[2]'>Social Network</p>
                             <div className=' lg:px-5 font-nova text-xl uppercase flex justify-between items-center'>
                                <Link href={"https://www.linkedin.com/in/szaib-dev.com"} target='_blank' className='hover:text-title '>LN</Link>
                                <Link href={"https://www.instagram.com/szb_121"} target='_blank' className='hover:text-title '>IG</Link>
                                <Link href={"https://github.com/szbr1/"} target='_blank' className='hover:text-title '>GH</Link>
                             </div>
                    </div>
                </div>
            </div>
