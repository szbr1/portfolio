    ...
    <div className='mt-25 mb-20' >
      <div className='flex justify-between items-center'>
        ...
        <div className='relative mr-24 mb-10'>
                ...
                <Link href={"https://wa.me/923205016373"}  className='absolute z-10 top-0 left-0 h-8 flex justify-center items-center font-semibold  w-24 uppercase text-white bg-title '>
                    hire me
                </Link>
        </div>
